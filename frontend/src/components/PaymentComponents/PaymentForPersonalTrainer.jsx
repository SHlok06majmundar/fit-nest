...
const PaymentForPersonalTrainer = () => {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const orderResponse = await axios.post('http://13.211.182.131:5000/api/Payment/create-order-for-trainer', {
                TrainerId,
                userId,
                amount: amount,
                ...
                handler: async (response) => {
                    ...
                    try {
                        const verifyResponse = await axios.post(
                            'http://13.211.182.131:5000/api/Payment/verify-payment-for-trainer',
                            {
                        ...
                        if (verifyResponse.data.success) {
                            ...
                            navigate(`/Success/:${orderId}/${userId}/${TrainerId}/${amount}`, { state: { invoice_url: verifyResponse.data.invoice_url, trainer: verifyResponse.data.trainer } });
                        } else {
                            setLoading(false)
