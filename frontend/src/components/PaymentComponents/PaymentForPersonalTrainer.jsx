...
const PaymentForPersonalTrainer = () => {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const orderResponse = await axios.post('https://www.fit-nest.in/api/Payment/create-order-for-trainer', {
                TrainerId,
                userId,
                amount: amount,
                ...
                handler: async (response) => {
                    ...
                    try {
                        const verifyResponse = await axios.post(
                            'https://www.fit-nest.in/api/Payment/verify-payment-for-trainer',
                            {
