...
const CartPage = () => {
  ...
  const GetProductById = async (id) => {
    try {
      const response = await axios.get(`https://www.fit-nest.in/api/products/product-by-id/${id}`, { withCredentials: true });
  ...
  useEffect(() => {
    const fetchDiscountCodes = async () => {
      try {
        const response = await axios.get('https://www.fit-nest.in/api/Admin/get-discount-codes', { withCredentials: true }); // Update with your backend route
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get('https://www.fit-nest.in/api/products/AllProducts', { withCredentials: true });
      const map = {};
  ...
  const handleIncrement = async (product) => {
      ...
      try {
        ...
        if (existingProductIndex !== -1) {
          ...
          const response = await axios.put(
            `https://www.fit-nest.in/api/products/decrementProduct-guest/${product.cart.product}`,
            { cartItem },
    ...
    try {
      const response = await axios.put(
        `https://www.fit-nest.in/api/Cart/AddToCart/${Authuser._id}/${product.cart.product}`, {}, { withCredentials: true }
      );
  ...
  const handleDecrement = async (product) => {
    ...
    try {
      const response = await axios.put(
        `https://www.fit-nest.in/api/Cart/DecrementCart/${Authuser._id}/${product.cart.product}`
        , {}, { withCredentials: true }
      );
  ...
  const handleRemoveFromCart = async (productId) => {
    ...
    try {
      const response = await axios.delete(`https://www.fit-nest.in/api/Cart/DeleteFromCart/${Authuser._id}/${productId}`,
        { withCredentials: true }
      );
  ...
  const handleSaveAddress = async () => {
    if (!Authuser) {
      ...
      try {
        const response = await axios.put(`https://www.fit-nest.in/api/users/change-address/${Authuser._id}`, { address: editedAddress }, { withCredentials: true });
        if (response.status === 200) {
