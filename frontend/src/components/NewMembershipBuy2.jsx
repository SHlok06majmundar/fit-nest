  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const orderResponse = await axios.post(
        'https://www.fit-nest.in/api/Payment/create-order-for-new-membership',
        {
          type: type,
          amount: price,
          userId: userId
        ...
        handler: async (response) => {
          ...
          try {
            ...
            const verifyResponse = await axios.post(
              'https://www.fit-nest.in/api/Payment/verify-payment-for-new-membership',
              {
...
export default NewMembershipBuy2
