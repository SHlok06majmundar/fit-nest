...
const AdminPdfRequests = () => {
  ...
  const fetchRequests = async () => {
    try {
      const response = await axios.get("http://13.211.182.131:5000/api/Admin/get-user-plan-pdf-requests", { withCredentials: true });
  ...
  const deleteRequest = async (id) => {
    try {
      await axios.delete(`http://13.211.182.131:5000/api/Admin/delete-user-plan-pdf-request/${id}`, { withCredentials: true });
