...
const AdminPdfRequests = () => {
  ...
  const fetchRequests = async () => {
    try {
      const response = await axios.get("https://www.fit-nest.in/api/Admin/get-user-plan-pdf-requests", { withCredentials: true });
  ...
  const deleteRequest = async (id) => {
    try {
      await axios.delete(`https://www.fit-nest.in/api/Admin/delete-user-plan-pdf-request/${id}`, { withCredentials: true });
