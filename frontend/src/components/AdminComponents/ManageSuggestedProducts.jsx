...
const ManageSuggestedProducts = () => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get('https://www.fit-nest.in/api/products/AllProducts', { withCredentials: true }); // Update with your backend route
  ...
  const saveSuggestedProducts = async () => {
    ...
    try {
      const response = await axios.post('https://www.fit-nest.in/api/Admin/save-suggested-products', { productIds: selectedProducts }
