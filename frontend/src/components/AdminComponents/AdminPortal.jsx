...
const AdminPortal = () => {
  ...
  const fetchEmails = async () => {
    try {
      const response = await axios.get("https://www.fit-nest.in/api/users/get-all-emails", { withCredentials: true });
  ...
  const fetchTrainerEmails = async () => {
    try {
      const response = await axios.get("https://www.fit-nest.in/api/Trainer/AllMails", { withCredentials: true });
  ...
  const fetchMembershipDetails = async () => {
    try {
      const response = await axios.get("https://www.fit-nest.in/api/users/MemberShipDetails", { withCredentials: true });
