...
const Dashboard = () => {
  ...
  const fetchInactiveMembers = async () => {
    try {
      const response = await axios.get('http://13.211.182.131:5000/api/users/inactive-members', { withCredentials: true });
  ...
  const fetchSalesByProduct = async (startDate, endDate) => {
    try {
      const response = await axios.get(`http://13.211.182.131:5000/api/Admin/getSalesDataByProduct/${startDate}/${endDate}`
