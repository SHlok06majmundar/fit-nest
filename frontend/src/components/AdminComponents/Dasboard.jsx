...
const Dashboard = () => {
  ...
  const fetchInactiveMembers = async () => {
    try {
      const response = await axios.get('https://www.fit-nest.in/api/users/inactive-members', { withCredentials: true });
  ...
  const fetchSalesByProduct = async (startDate, endDate) => {
    try {
      const response = await axios.get(`https://www.fit-nest.in/api/Admin/getSalesDataByProduct/${startDate}/${endDate}`
