...
const ManageHomeMedia = () => {
  ...
  useEffect(() => {
    ...
    const fetchMedia = async () => {
      try {
        const response = await axios.get("https://www.fit-nest.in/api/Admin/home-media", {
  ...
  const handleSaveHomeMedia = async () => {
    try {
      const response = await axios.put("https://www.fit-nest.in/api/Admin/put-home-media", {
        homeLogo,
        homePageVideo,
      }, {
        withCredentials: true,
  ...
  const handleAddCustomMedia = async () => {
    ...
    try {
      const response = await axios.post("https://www.fit-nest.in/api/Admin/custom-media", newMedia, {
        withCredentials: true,
      });
