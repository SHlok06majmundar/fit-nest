...
const DescriptionBox = () => {
  ...
  const handleAddToCart = async (product) => {
      ...
      try {
        ...
        if (existingProductIndex !== -1) {
          ...
          const response = await axios.put(
            `https://www.fit-nest.in/api/products/decrementProduct-guestDescBox/${product._id}`,
    ...
    try {
      const response = await axios.put(`https://www.fit-nest.in/api/Cart/AddToCartDescBox/${Authuser._id}/${product._id}`
        , {count:count},
      );
